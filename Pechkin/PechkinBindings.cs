...
namespace Pechkin
{
    ...
    internal static class PechkinBindings
    {
        ...
        {
            SetupUnmanagedAssembly("libeay32.dll", Resources.libeay32);
            SetupUnmanagedAssembly("libgcc_s_dw2-1.dll", Resources.libgcc_s_dw2_1);
            SetupUnmanagedAssembly("mingwm10.dll", Resources.mingwm10);
            SetupUnmanagedAssembly("ssleay32.dll", Resources.ssleay32);
            SetupUnmanagedAssembly("wkhtmltox0.dll", Resources.wkhtmltox0);
        }
        ...
        private static void SetupUnmanagedAssembly(string fileName, byte[] assemblyRaw)
        {
            ...
            var basePath = Path.Combine(
                Path.GetTempPath(),
                string.Format("{0}{1}", assemblyName.Name.ToString(), assemblyName.Version.ToString()));
